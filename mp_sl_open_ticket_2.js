...
function onRequest(context) {
	if (context.request.method === "GET") {
		...
		if (!isNullorEmpty(params)) {
			...
			if (
				!isNullorEmpty(params.selector_number) &&
				!isNullorEmpty(params.selector_type)
			) {
				...
				if (!isNullorEmpty(params.ticket_id)) {
					...
					creator_name = ticketRecord.getText({
						fieldId: "custrecord_creator",
					});
					creator_id = ticketRecord.getValue({
						fieldId: "custrecord_creator",
					});
					status_value = ticketRecord.getValue({
						fieldId: "custrecord_ticket_status",
					});
					escalated_to_it = ticketRecord.getValue({
						fieldId: "custrecord_date_escalated_it",
					});
					status = ticketRecord.getText({
						fieldId: "custrecord_ticket_status",
					});
					customer_id = ticketRecord.getValue({
						fieldId: "custrecord_customer1",
					});
					customer_name = ticketRecord.getText({
						fieldId: "custrecord_customer1",
					});
					zee_id = ticketRecord.getValue({ fieldId: "custrecord_zee" });
					selected_enquiry_status_id = ticketRecord.getValue({
						fieldId: "custrecord_enquiry_status",
					});
					attachments_hyperlink = ticketRecord.getValue({
						fieldId: "custrecord_mp_ticket_attachments",
					});
					selected_label_id = ticketRecord.getValue({
						fieldId: "custrecord_ticket_label",
					});
					list_enquiry_mediums = ticketRecord.getValue({
						fieldId: "custrecord_enquiry_medium",
					});
					list_enquiry_mediums = java2jsArray(list_enquiry_mediums);
					total_enquiry_count = ticketRecord.getValue({
						fieldId: "custrecord_enquiry_count",
					});
					chat_enquiry_count = ticketRecord.getValue({
						fieldId: "custrecord_chat_enquiry_count",
					});
					phone_enquiry_count = ticketRecord.getValue({
						fieldId: "custrecord_phone_enquiry_count",
					});
					phone_interaction_count = ticketRecord.getValue({
						fieldId: "custrecord_phone_interaction_count",
					});
					email_interaction_count = ticketRecord.getValue({
						fieldId: "custrecord_email_interaction_count",
					});
					email_enquiry_count = ticketRecord.getValue({
						fieldId: "custrecord_email_enquiry_count",
					});
					portal_enquiry_count = ticketRecord.getValue({
						fieldId: "custrecord_portal_enquiry_count",
					});
					customer_issue = ticketRecord.getValue({
						fieldId: "custrecord_customer_issue",
					});
					screenshot_file = ticketRecord.getValue({
						fieldId: "custrecord_screenshot",
					});
					browser = ticketRecord.getValue({ fieldId: "custrecord_browser" });
					login_email_used = ticketRecord.getValue({
						fieldId: "custrecord_login_email",
					});
					operating_system = ticketRecord.getValue({
						fieldId: "custrecord_operating_system",
					});
					phone_used = ticketRecord.getValue({
						fieldId: "custrecord_phone_used",
					});
					customer_number = ticketRecord.getValue({
						fieldId: "custrecord_cust_number",
					});
					old_sender_name = ticketRecord.getValue({
						fieldId: "custrecord_sender_name",
					});
					old_sender_phone = ticketRecord.getValue({
						fieldId: "custrecord_sender_phone",
					});
					customer_number_email_sent = ticketRecord.getValue({
						fieldId: "custrecord_customer_number_email_sent",
					});
					customer_barcode_number = ticketRecord.getValue({
					...
					if (!isNullorEmpty(customer_barcode_number)) {
						...
						receiveremail = rec.getValue({
							fieldId: "custrecord_receiver_email",
						});
						receiverphone = rec.getValue({
							fieldId: "custrecord_receiver_phone",
						});
						receivername = rec.getValue({
							fieldId: "custrecord_receiver_name",
						});
						receiverstate = rec.getValue({
							fieldId: "custrecord_receiver_state",
						});
						receiverzip = rec.getValue({
							fieldId: "custrecord_receiver_postcode",
						});
						receiversuburb = rec.getValue({
							fieldId: "custrecord_receiver_suburb",
						});
						receiveraddr1 = rec.getValue({
							fieldId: "custrecord_receiver_addr1",
						});
						receiveraddr2 = rec.getValue({
							fieldId: "custrecord_receiver_addr2",
						});
						senderName = rec.getValue({ fieldId: "custrecord_senders_name" });
						senderEmail = rec.getValue({
							fieldId: "custrecord_sender_email",
						});
						senderPhone = rec.getValue({
							fieldId: "custrecord_senders_phone",
						});
						senderAddress = rec.getValue({
							fieldId: "custrecord_sender_address_1",
						});
						productName = rec.getText({
							fieldId: "custrecord_cust_prod_stock_single_name",
						});
						...
						prod_stock_invoice = rec.getText({
							fieldId: "custrecord_prod_stock_invoice",
						});
						barcodempdl = rec.getValue({ fieldId: "custrecord_mpdl_number" });
						barcodeintegration = rec.getValue({
							fieldId: "custrecord_integration",
						});
						barcodesource = rec.getText({
							fieldId: "custrecord_barcode_source",
						});
						connote_number = rec.getValue({
							fieldId: "custrecord_connote_number",
						});
					}
					...
					if (isNullorEmpty(customer_id) && !isNullorEmpty(customer_number)) {
						...
						log.debug({
							title:
								"customer_search.run().getRange({ start: 0,end:1 })[0].id",
							details: customer_search.run().getRange({ start: 0, end: 1 })[0]
								.id,
						});
						customer_id = customer_search
							.run()
					...
					if (!isNullorEmpty(customer_id)) {
						...
						customer_number = customerRecord.getValue({
							fieldId: "entityid",
						});
						daytodayphone = customerRecord.getValue({ fieldId: "phone" });
						daytodayemail = customerRecord.getValue({
							fieldId: "custentity_email_service",
						});
						terms = customerRecord.getValue({ fieldId: "terms" });
						customer_terms = customerRecord.getValue({
							fieldId: "custentity_finance_terms",
						});
						// Account manager
						var accountManagerSearch = search.load({
							type: "customer",
							id: "customsearch3413",
						});
						accountManagerSearch.filters.push(
							search.createFilter({
								name: "internalid",
								join: null,
						...
						var accountManagerResult = accountManagerResultSet.getRange({
							start: 0,
							end: 1,
						});
						...
						if (!isNullorEmpty(accountManagerResult)) {
							var account_manager_value = accountManagerResult.getValue({
								name: "custrecord_sales_assigned",
								join: "CUSTRECORD_SALES_CUSTOMER",
								summary: null,
							});
							var account_manager_text = accountManagerResult.getText({
								name: "custrecord_sales_assigned",
								join: "CUSTRECORD_SALES_CUSTOMER",
								summary: null,
							});
					...
					switch (selector_type) {
						...
						case "invoice_number":
							...
							accountsphone = customerRecord.getValue({
								fieldId: "altphone",
							});
							accountsemail = customerRecord.getValue({ fieldId: "email" });

							maap_bank_account_number = customerRecord.getValue({
								fieldId: "custentity_maap_bankacctno",
							});
							maap_parent_bank_account_number = customerRecord.getValue({
								fieldId: "custentity_maap_bankacctno_parent",
							});

							selected_invoice_method_id = customerRecord.getValue({
								fieldId: "custentity_invoice_method",
							});
							accounts_cc_email = customerRecord.getValue({
								fieldId: "custentity_accounts_cc_email",
							});
							mpex_po_number = customerRecord.getValue({
								fieldId: "custentity_mpex_po",
							});
							customer_po_number = customerRecord.getValue({
								fieldId: "custentity11",
							});
							selected_invoice_cycle_id = customerRecord.getValue({
								fieldId: "custentity_mpex_invoicing_cycle",
							});

							usage_report_id_1 = invoiceRecord.getValue({
								fieldId: "custbody_mpex_usage_report",
							});
							usage_report_id_2 = invoiceRecord.getValue({
								fieldId: "custbody_mpex_usage_report_2",
							});
							usage_report_id_3 = invoiceRecord.getValue({
								fieldId: "custbody_mpex_usage_report_3",
							});
							usage_report_id_4 = invoiceRecord.getValue({
								fieldId: "custbody_mpex_usage_report_4",
							});
							var usage_report_id_array = [
								usage_report_id_1,
								usage_report_id_2,
								usage_report_id_3,
								usage_report_id_4,
		...
		// Define alert window.
		inlineHtml +=
			'<div class="container" style="margin-top:14px;" hidden><div id="danger-alert" class="alert alert-danger fade in"></div></div>';
		...
		form
			.addField({
				id: "custpage_selector_id",
				type: ui.FieldType.TEXT,
				label: "Selector ID",
			})
			.updateDisplayType({
				displayType: ui.FieldDisplayType.HIDDEN,
			}).defaultValue = selector_id;
		form
			.addField({
				id: "custpage_selector_issue",
				type: ui.FieldType.TEXT,
				label: "Barcode issue",
			})
			.updateDisplayType({
		...
		form
			.addField({
				id: "custpage_ticket_status_value",
				type: ui.FieldType.TEXT,
				label: "Status Value",
			})
			.updateDisplayType({
		...
		form
			.addField({
				id: "custpage_usage_report_array",
				type: ui.FieldType.TEXT,
				label: "Usage Reports",
			})
			.updateDisplayType({
				displayType: ui.FieldDisplayType.HIDDEN,
			}).defaultValue = JSON.stringify(usage_report_array);
		form
			.addField({
				id: "custpage_param_email",
				type: ui.FieldType.TEXT,
				label: "Email parameters",
			})
			.updateDisplayType({
				displayType: ui.FieldDisplayType.HIDDEN,
			}).defaultValue = JSON.stringify(params_email);
		form
			.addField({
				id: "custpage_ss_image",
				type: ui.FieldType.TEXT,
				label: "Screenshot Image",
			})
			.updateDisplayType({
				displayType: ui.FieldDisplayType.HIDDEN,
			}).defaultValue = screenshot_file;
		form
			.addField({
				id: "custpage_customer_number_email_sent",
				type: ui.FieldType.TEXT,
				label: "Customer Email Sent",
			})
			.updateDisplayType({
				displayType: ui.FieldDisplayType.HIDDEN,
			}).defaultValue = customer_number_email_sent;
		...
		if (created_ticket == "T") {
			...
			var selector_number =
				context.request.parameters.custpage_selector_number;
...
function instructionsBox(ticket_id) {
	...
	inlineHtml +=
		'<div style="background-color: #e3e8e5 !important;border: 2px solid #095C7B;padding: 20px 30px 30px 30px; text-align: left"><b><u>Mandatory Fields:</u></b>';
	inlineHtml += "<ul>";
	inlineHtml +=
		"<li><b><u>Ticket Details</u></b>: Total Enquiry Count must be at least 1 i.e. Chat/Email/Phone must have at least 1 incremented and Receiver Details should be filled in if blank</li>";
	inlineHtml +=
		"<li><b><u>Issues</u></b>: Owner and Toll Emails must have at least one selected</li>";
	inlineHtml += "<li>If you have any issues, please contact Ankith</li>";
	inlineHtml += "</ul></div></div><br/>";
	return inlineHtml;
}

function externalBarcodeSource(
	selector_type,
	barcodeintegration,
	barcodempdl,
	barcodesource,
	...
	if (selector_type == "barcode_number") {
		...
		// Product Type field
		inlineQty += '<div class="col-xs-4 barcodempdl_div">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="barcodempdl_text">Product Type</span>';
		inlineQty +=
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="barcodempdl_text">INTEGRATION</span>';
		inlineQty +=
			'<input id="barcodempdl" value="' +
			barcodeintegration +
			'" class="form-control barcodempdl" ' +
			disabled +
			" />";
		inlineQty += "</div></div>";
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="barcodempdl_text">EXTERNAL BARCODE</span>';
		inlineQty +=
			'<input id="barcodempdl" value="' +
			barcodempdl +
			'" class="form-control barcodempdl" ' +
		...
		inlineQty += '<div class="col-xs-4 barcodesource_div">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="barcodesource_text">BARCODE SOURCE</span>';
		inlineQty +=
			'<input id="barcodesource" value="' +
			barcodesource +
			'" class="form-control barcodesource" ' +
			disabled +
			" />";
...
function tabsSection(
	...
	if (!isNullorEmpty(ticket_id)) {
		if (
			...
			inlineQty +=
				'<button style="float: left; margin-left: 10px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="updateticketbutton" onclick="">Update & New Ticket</button>';
			inlineQty +=
				'<button style="float: left; margin-left: 5x; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="updatecloseticketbutton" onclick="">Update & Close Ticket</button>';
		} else if (!isTicketNotClosed(status_value)) {
			inlineQty +=
				'<button style="float: left; margin-left: 10px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="reopenticketbutton" onclick="">Reopen Ticket</button>';
		}
	} else {
		...
		inlineQty +=
			'<button style="float: left; margin-left: 10px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="opennewticketbutton" onclick="">Save & New Ticket</button>';
	}

	if (isTicketNotClosed(status_value)) {
		if (!isNullorEmpty(ticket_id) && selector_type != "customer_issue") {
			inlineQty +=
				'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #f4524d; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="closeticketbutton" onclick="">Close Ticket</button>';
			inlineQty +=
				'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #f4524d; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="closenewticketbutton" onclick="">Close & New Ticket</button>';
			inlineQty +=
				'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #f4524d; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="closelostbutton" onclick="">Close Ticket - Lost Item</button>';

			if (userId == 409635 || userId == 696992 || userId == 766498) {
				inlineQty +=
					'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="closeunallocatedbutton" onclick="">Close Unallocated Ticket</button>';
			}
		} else if (
			!isNullorEmpty(ticket_id) &&
			(userRole == 1032 || userRole == 3) &&
			selector_type == "customer_issue"
		) {
			inlineQty +=
				'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #f4524d; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="closeresolvedbutton" onclick="">Close - Resolved Ticket</button>';
			inlineQty +=
				'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #f4524d; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="closeunresolvedbutton" onclick="">Close - Unresolved Ticket</button>';
		} else {
			inlineQty +=
				'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #f4524d; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="closeticketbutton" onclick="">Close Ticket</button>';
		}
	...
	log.debug({
		title: "!isNullorEmpty(ticket_id)",
		details: !isNullorEmpty(ticket_id),
	});
	log.debug({
		title: "userId",
		details: userId,
	...
	if (
		...
		inlineQty +=
			'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #fc9003; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="escalaterianne" onclick="">Escalate To IT</button>';
	} else if (
		selector_type == "customer_issue" &&
		isTicketNotClosed(status_value) &&
		!isNullorEmpty(ticket_id) &&
		...
		inlineQty +=
			'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #fc9003; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="escalateunderdev" onclick="">Set Status to Under Development</button>';
	} else if (
		selector_type == "customer_issue" &&
		isTicketNotClosed(status_value) &&
		!isNullorEmpty(ticket_id) &&
		...
		inlineQty +=
			'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #fc9003; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="escalateremoveunderdev" onclick="">Remove Under Development Status</button>';
	} else if (
		isTicketNotClosed(status_value) &&
		!isNullorEmpty(ticket_id) &&
		selector_type != "customer_issue"
		...
		inlineQty +=
			'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #095C7B; color: #fff; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="escalatebutton" onclick="">' +
			escalateButton(status_value) +
			"</button>";
	}

	if (!isNullorEmpty(ticket_id) && !isTicketNotClosed(status_value)) {
		inlineQty +=
			'<button style="float: left; margin-left: 10px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="cancelbutton" onclick="">Cancel</button>';
	} else {
		inlineQty +=
			'<button style="float: left; margin-left: 5px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="cancelbutton" onclick="">Cancel</button>';
	}

	// Title
	if (!isNullorEmpty(ticket_id)) {
		inlineQty +=
			'<h1 style="display: inline-block; font-size: 25px; margin-top: 20px; font-weight: 700; color: #103D39; text-align: center; width: 100%">Edit Ticket - MPSD' +
			ticket_id +
			"</h1>";
	} else {
		inlineQty +=
			'<h1 style="display: inline-block; font-size: 25px; font-weight: 700; color: #103D39; text-align: center; width: 100%">Open New Ticket</h1>';
	}
	...
	inlineQty +=
		'<div class="form-group container tickets_details_header_section" style="margin-top: 10px">';
	inlineQty += '<div class="row">';
	...
	inlineQty +=
		'<li role="presentation" class="active"><a data-toggle="tab" href="#ticketdetails"><b>TICKET DETAILS</b></a></li>';
	inlineQty +=
		'<li role="presentation" class=""><a data-toggle="tab" href="#issues"><b>ISSUES</b></a></li>';

	if (!isNullorEmpty(ticket_id)) {
		inlineQty +=
			'<li role="presentation" class=""><a data-toggle="tab" href="#sendemail"><b>SEND EMAIL</b></a></li>';
	} else {
		inlineQty +=
			'<li role="presentation" class=""><a data-toggle="tab" href="#contactdetails"><b>CONTACT DETAILS</b></a></li>';
	}

	if (!isNullorEmpty(ticket_id)) {
		inlineQty +=
			'<li role="presentation" class=""><a data-toggle="tab" href="#prevtickets"><b>PREVIOUS TICKETS</b></a></li>';
		inlineQty +=
			'<li role="presentation" class=""><a data-toggle="tab" href="#prevemails"><b>PREVIOUS EMAILS</b></a></li>';
	}
	...
	inlineQty += customerNumberSection(
		customer_number,
		ticket_id,
		selector_type,
		escalated_to_it,
	...
	if (!isNullorEmpty(ticket_id)) {
		inlineQty += ticketSection(
			dateISOToNetsuite(date_created),
			creator_id,
			creator_name,
			status,
			connote_number
		);
		inlineQty += externalBarcodeSource(
			selector_type,
			barcodeintegration,
			barcodempdl,
			barcodesource,
	...
	if (
		isNullorEmpty(ticket_id) ||
		(!isNullorEmpty(ticket_id) && !isNullorEmpty(customer_id)) ||
		!isNullorEmpty(customer_number)
	) {
		inlineQty += customerSection(customer_name);
		inlineQty += daytodayContactSection(
			daytodayphone,
			daytodayemail,
			status_value,
			selector_type
		);
		inlineQty += accountsContactSection(
			accountsphone,
			accountsemail,
			status_value,
			selector_type
	...
	if (
		isNullorEmpty(ticket_id) ||
		(!isNullorEmpty(ticket_id) && selector_type == "invoice_section")
	) {
		inlineQty += maapBankAccountSection(
			maap_bank_account_number,
			maap_parent_bank_account_number,
			selector_type
		);
	...
	if (
		isNullorEmpty(ticket_id) ||
		(!isNullorEmpty(ticket_id) && !isNullorEmpty(zee_id)) ||
		!isNullorEmpty(customer_number)
	) {
		inlineQty += franchiseeMainContactSection(
			franchisee_name,
			zee_main_contact_name,
			zee_email,
			zee_main_contact_phone,
	...
	inlineQty += mpexStockUsedSection(
		selector_type,
		date_stock_used,
		time_stock_used
	);
	inlineQty += finalDeliveryEnquirySection(
		status_value,
		selector_type,
		final_delivery_text,
		selected_enquiry_status_id,
	...
	if (
		isNullorEmpty(ticket_id) ||
		(!isNullorEmpty(ticket_id) && selector_type == "invoice_number")
	) {
		inlineQty += otherInvoiceFieldsSection(
			selected_invoice_method_id,
			accounts_cc_email,
			mpex_po_number,
			customer_po_number,
	...
	inlineQty += enquiryMediumSection(
		list_enquiry_mediums,
		selected_enquiry_status_id,
		selector_type
	);
	inlineQty += enquiryCountSection(
		total_enquiry_count,
		chat_enquiry_count,
		phone_enquiry_count,
		email_enquiry_count,
	...
	inlineQty += customerIssuesSection(
		ticket_id,
		selector_type,
		selector_number,
		screenshot_file,
 ...
 */
function customerNumberSection(
	customer_number,
	ticket_id,
	selector_type,
	escalated_to_it,
	...
	inlineQty +=
		'<h4><span style="background-color: #095C7B" class="label label-default col-xs-12">TICKET DETAILS</span></h4>';
	inlineQty += "</div></div></div>";
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="customer_number_text">CUSTOMER NUMBER</span>';

	if (customer_number == "" && isNullorEmpty(ticket_id)) {
		inlineQty +=
			'<input id="customer_number_value" value=" ' +
			customer_number +
			' " class="form-control customer_number">';
	} else if (
		customer_number == "" &&
		creator_id == 112209 &&
		!isNullorEmpty(escalated_to_it) &&
		...
		inlineQty +=
			'<input id="customer_number_value" value=" ' +
			customer_number +
			' " class="form-control customer_number" disabled>';
	}
	inlineQty += "</div></div></div></div>";
	...
	inlineQty +=
		"<style> table {font-size: 12px;text-align: center;border: none;} {font-size: 14px;} table th{text-align: center;} .dataTables_wrapper{width:78%; margin-bottom:40px; margin-left: auto; margin-right: auto; margin-top: auto;} </style>";
	inlineQty +=
		'<table cellpadding="15" id="customer_number_tickets_preview" class="table table-responsive table-striped customer tablesorter" cellspacing="0" style="width: 100%;">';
...
function selectorSection(
	...
	if (!isNullorEmpty(ticket_id)) {
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="ticket_id_text">TICKET ID</span>';
		inlineQty +=
			'<input id="ticket_id" value="MPSD' +
			ticket_id +
			'" class="form-control ticket_id" disabled />';
		inlineQty += "</div></div>";
		...
		switch (selector_type) {
			case "barcode_number":
				inlineQty +=
					'<span class="input-group-addon" id="selector_text">BARCODE NUMBER</span>';
				break;
			case "invoice_number":
				inlineQty +=
					'<span class="input-group-addon" id="selector_text">INVOICE NUMBER</span>';
				break;
			case "customer_issue":
				inlineQty +=
					'<span class="input-group-addon" id="selector_text">CUSTOMER ISSUE</span>';
			case "operations_issue":
				inlineQty +=
					'<span class="input-group-addon" id="selector_text">OPERATIONS ISSUE</span>';
				break;
		}
		inlineQty +=
			'<input id="selector_value" value="' +
			selector_number +
			'" class="form-control selector_value" disabled>';
		if (selector_type == "invoice_number") {
			// Open Invoice record
			inlineQty += '<div class="input-group-btn">';
			inlineQty +=
				'<button id="open_inv" type="button" class="btn btn-default link_inv" data-inv-id="' +
				selector_id +
				'" data-toggle="tooltip" data-placement="top" title="Open Invoice">';
			...
			if (isTicketNotClosed(status_value)) {
				inlineQty +=
					'<div class="input-group-btn"><button style="background-color: #095C7B" id="add_inv" type="button" class="btn btn-success add_inv" data-inv-id="' +
					selector_id +
		...
		inlineQty += "</button>";
		inlineQty +=
			'<ul class="dropdown-menu hide" style="list-style:none;margin: 2px 0 0;">';
		...
		inlineQty += '<li><a href="#">OPERATIONS</a></li>';
		inlineQty += "</ul>";
		inlineQty += "</div>";
		//Input text
		switch (selector_type) {
			case "barcode_number":
				inlineQty +=
					'<input id="selector_value" class="form-control selector_value" placeholder="MPEN123456">';
				break;
			case "invoice_number":
				inlineQty +=
					'<input id="selector_value" class="form-control selector_value" placeholder="INV123456">';
				break;
			case "customer_app":
				inlineQty +=
					'<input id="selector_value" class="form-control selector_value" placeholder="Customer App" disabled value="Customer App">';
				break;
			case "customer_portal":
				inlineQty +=
					'<input id="selector_value" class="form-control selector_value" placeholder="Customer Portal" disabled value="Customer Portal">';
				break;
			case "update_label":
				inlineQty +=
...
function ticketSection(
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="date_created_text">DATE CREATED</span>';
	inlineQty +=
		'<input id="date_created" value="' +
		date_created +
		'" class="form-control date_created" disabled />';
	inlineQty += "</div></div>";
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="creator_text">CREATOR</span>';
	inlineQty +=
		'<input id="creator" value="' +
		creator_name +
		'" data-creator-id="' +
		creator_id +
		'" class="form-control creator" disabled />';
	inlineQty += "</div></div></div></div>";
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="status_text">STATUS</span>';
	inlineQty +=
...
function customerSection(customer_name) {
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="customer_name_text">CUSTOMER NAME</span>';
	inlineQty +=
		'<input id="customer_name" value="' +
		customer_name +
...
/**
	...
	* @return  {String}    inlineQty
	*/
function daytodayContactSection(
	daytodayphone,
	daytodayemail,
	status_value,
	selector_type
	...
	var inlineQty =
		'<div class="form-group container daytodaycontact_section">';
	inlineQty += '<div class="row">';
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="daytodayemail_text">DAY-TO-DAY EMAIL</span>';
	inlineQty +=
		'<input id="daytodayemail" type="email" value="' +
		daytodayemail +
		'" class="form-control daytodayemail" ' +
		disabled +
		" />";
	inlineQty += '<div class="input-group-btn">';
	inlineQty +=
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="daytodayphone_text">DAY-TO-DAY PHONE</span>';
	inlineQty +=
		'<input id="daytodayphone" type="tel" value="' +
		daytodayphone +
		'" class="form-control daytodayphone" ' +
		disabled +
		" />";
	inlineQty +=
		'<div class="input-group-btn"><button type="button" style="background-color: #095C7B" class="btn btn-success" id="call_daytoday_phone"><span class="glyphicon glyphicon-earphone"></span></button></div>';
	inlineQty += "</div></div></div></div>";
...
function senderDetails(
	...
	if (
		isNullorEmpty(senderName) &&
		isNullorEmpty(senderEmail) &&
		isNullorEmpty(senderPhone) &&
		isNullorEmpty(senderAddress)
	) {
		disabled = "";
	}
	var inlineQty = "";
	...
	if (selector_type == "barcode_number") {
		...
		inlineQty += '<div class="col-xs-12 heading2"  >';
		inlineQty +=
			'<h4><span style="background-color: #095C7B" class="label label-default col-xs-12">SENDER DETAILS</span></h4>';
		inlineQty += "</div></div></div>";

		//First Row
		inlineQty += '<div class="form-group container sendercontact_section">';
		inlineQty += '<div class="row">';

		// name field
		inlineQty += '<div class="col-xs-4 sendername_div">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="sendername_text">NAME</span>';
		inlineQty +=
			'<input id="sendername" value="' +
			senderName +
		...
		// Day to day phone field
		inlineQty += '<div class="col-xs-4 senderphone_div">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="senderphone_text">PHONE</span>';
		inlineQty +=
			'<input id="senderphone" type="tel" value="' +
			senderPhone +
			'" class="form-control senderphone" ' +
			disabled +
			" />";
		inlineQty +=
			'<div class="input-group-btn"><button type="button" style="background-color: #095C7B" class="btn btn-success" id="call_sender_phone"><span class="glyphicon glyphicon-earphone"></span></button></div>';
		inlineQty += "</div></div>";

		// Day to day email field
		inlineQty += '<div class="col-xs-4 senderemail_div">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="senderemail_text">EMAIL</span>';
		inlineQty +=
			'<input id="senderemail" type="email" value="' +
			senderEmail +
			'" class="form-control senderemail" ' +
			disabled +
			" />";
		inlineQty += '<div class="input-group-btn">';
		inlineQty +=
		...
		//2nd Row
		inlineQty +=
			'<div class="form-group container receivercontact2_section">';
		inlineQty += '<div class="row">';

		// address1 field
		inlineQty += '<div class="col-xs-12 senderaddress_div">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="senderaddress_text">ADDRESS</span>';
		inlineQty +=
			'<input id="senderaddress" value="' +
			senderAddress +
			'" class="form-control senderaddress" ' +
			disabled +
			" />";
		inlineQty += "</div></div>";
...
function receiverEmailPhone(
	...
	if (
		isNullorEmpty(receiveremail) &&
		isNullorEmpty(receiveraddr1) &&
		isNullorEmpty(receiveraddr2) &&
		isNullorEmpty(receivername) &&
		isNullorEmpty(receiverphone) &&
		isNullorEmpty(receiverstate) &&
		isNullorEmpty(receiverzip) &&
		isNullorEmpty(receiversuburb)
	) {
		disabled = "";
	}
	var inlineQty = "";
	...
	if (selector_type == "barcode_number") {
		...
		inlineQty += '<div class="col-xs-12 heading2"  >';
		inlineQty +=
			'<h4><span style="background-color: #095C7B" class="label label-default col-xs-12">RECEIVER DETAILS</span></h4>';
		inlineQty += "</div></div></div>";
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="receivername_text">NAME</span>';
		inlineQty +=
			'<input id="receivername" value="' +
			receivername +
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="receiverphone_text">PHONE</span>';
		inlineQty +=
			'<input id="receiverphone" type="tel" value="' +
			receiverphone +
			'" class="form-control receiverphone" ' +
			disabled +
			" />";
		inlineQty +=
			'<div class="input-group-btn"><button type="button" style="background-color: #095C7B" class="btn btn-success" id="call_receiver_phone"><span class="glyphicon glyphicon-earphone"></span></button></div>';
		inlineQty += "</div></div>";
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="receiveremail_text">EMAIL</span>';
		inlineQty +=
			'<input id="receiveremail" type="email" value="' +
			receiveremail +
			'" class="form-control receiveremail" ' +
			disabled +
			" />";
		inlineQty += '<div class="input-group-btn">';
		inlineQty +=
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="receiveraddr1_text">ADDRESS1</span>';
		inlineQty +=
			'<input id="receiveraddr1" value="' +
			receiveraddr1 +
			'" class="form-control receiveraddr1" ' +
			disabled +
			" />";
		inlineQty += "</div></div>";
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="receiveraddr2_text">ADDRESS2</span>';
		inlineQty +=
			'<input id="receiveraddr2" value="' +
			receiveraddr2 +
			'" class="form-control receiveraddr2" ' +
			disabled +
			" />";
		inlineQty += "</div></div>";
		...
		//3rd Row
		inlineQty +=
			'<div class="form-group container receivercontact3_section">';
		inlineQty += '<div class="row">';
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="receiversuburb_text">SUBURB</span>';
		inlineQty +=
			'<input id="receiversuburb" value="' +
			receiversuburb +
			'" class="form-control receiversuburb" ' +
			disabled +
			" />";
		inlineQty += "</div></div>";
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="receiverzip_text">POSTCODE</span>';
		inlineQty +=
			'<input id="receiverzip" value="' +
			receiverzip +
			'" class="form-control receiverzip" ' +
			disabled +
			" />";
		inlineQty += "</div></div>";
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="receiverstate_text">STATE</span>';
		inlineQty +=
			'<input id="receiverstate" value="' +
			receiverstate +
			'" class="form-control receiverstate" ' +
			disabled +
			" />";
		inlineQty += "</div></div>";
 ...
 * @return  {String}    inlineQty
 */
function accountsContactSection(
	accountsphone,
	accountsemail,
	status_value,
	selector_type
	...
	if (selector_type == "invoice_number") {
		var inlineQty =
			'<div class="form-group container accountscontact_section">';
		...
		var inlineQty =
			'<div class="form-group container accountscontact_section hide">';
		var disabled = "disabled";
	}
	inlineQty += '<div class="row">';
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="accountsemail_text">ACCOUNTS EMAIL</span>';
	inlineQty +=
		'<input id="accountsemail" type="email" value="' +
		accountsemail +
		'" class="form-control accountsemail" ' +
		disabled +
		" />";
	inlineQty += '<div class="input-group-btn">';
	inlineQty +=
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="accountsphone_text">ACCOUNTS PHONE</span>';
	inlineQty +=
		'<input id="accountsphone" type="tel" value="' +
		accountsphone +
		'" class="form-control accountsphone" ' +
		disabled +
		" />";
	inlineQty +=
		'<div class="input-group-btn"><button type="button" style="background-color: #095C7B" class="btn btn-success" id="call_accounts_phone"><span class="glyphicon glyphicon-earphone"></span></button></div>';
	inlineQty += "</div></div></div></div>";
 ...
 */
function maapBankAccountSection(
	maap_bank_account_number,
	maap_parent_bank_account_number,
	selector_type
) {
	switch (selector_type) {
		case "barcode_number":
			var inlineQty =
				'<div class="form-group container accounts_number_section hide">';
			break;
	...
	inlineQty +=
		'<input id="account_number" type="number" value="' +
		maap_bank_account_number +
	...
	inlineQty +=
		'<input id="parent_account_number" type="number" value="' +
		maap_parent_bank_account_number +
 ...
 * @return  {String}    inlineQty
 */
function franchiseeMainContactSection(
	franchisee_name,
	zee_main_contact_name,
	zee_email,
	zee_main_contact_phone,
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="franchisee_name_text">SELECT FRANCHISEE</span>';
	inlineQty +=
	...
	inlineQty +=
		'<input id="franchisee_name" value="' +
		franchisee_name +
	...
	inlineQty +=
		'<input id="zee_main_contact_name" value="' +
		zee_main_contact_name +
	...
	inlineQty +=
		'<input id="zee_email" type="email" value="' +
		zee_email +
	...
	inlineQty +=
		'<input id="zee_main_contact_phone" type="tel" value="' +
		zee_main_contact_phone +
		'" class="form-control zee_main_contact_phone" disabled />';
	inlineQty +=
		'<div class="input-group-btn"><button style="background-color: #095C7B" type="button" class="btn btn-success" id="call_zee_main_contact_phone"><span class="glyphicon glyphicon-earphone"></span></button>';
	inlineQty += "</div>";
	inlineQty += "</div></div>";
	...
	inlineQty +=
		'<input id="zee_abn" class="form-control zee_abn" value="' +
		zee_abn +
		'" disabled>';
	inlineQty += "</div></div></div></div>";
...
function mpexStockUsedSection(
	...
	var inlineQty =
		'<div class="form-group container mpex_stock_used_section ' +
		hide_class +
		'">';
	inlineQty += '<div class="row">';
	// Date Stock Used
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="date_stock_used_text">DATE STOCK USED</span>';
	inlineQty +=
		'<input id="date_stock_used" class="form-control date_stock_used" value="' +
		date_stock_used +
		'" disabled>';
	inlineQty += "</div></div>";
	// Time Stock Used
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="time_stock_used_text">TIME STOCK USED</span>';
	inlineQty +=
		'<input id="time_stock_used" class="form-control time_stock_used" value="' +
		time_stock_used +
		'" disabled>';
	inlineQty += "</div></div></div></div>";
 ...
 * @return  {String} inlineQty
 */
function finalDeliveryEnquirySection(
	status_value,
	selector_type,
	final_delivery_text,
	selected_enquiry_status_id,
	...
	var inlineQty =
		'<div class="form-group container final_delivery_enquiry_status_section">';
	inlineQty += '<div class="row">';
	// Final Delivery
	inlineQty +=
		'<div class="col-xs-6 final_delivery ' + barcode_hide_class + '">';
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="final_delivery_text">FINAL DELIVERY</span>';
	inlineQty +=
		'<input id="final_delivery" class="form-control final_delivery" value="' +
		final_delivery_text +
		'" disabled>';
	inlineQty += "</div></div>";
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="invoice_text">INVOICE</span>';
	inlineQty +=
		'<input id="invoice" class="form-control invoice" value="' +
		prod_stock_invoice +
		'" disabled>';
	inlineQty += "</div></div>";
...
function labelSection(selected_label_id, selector_type, status_value) {
	...
	var inlineQty =
		'<div class="form-group container label_section ' +
		barcodeHideClass +
		'">';
	inlineQty += '<div class="row">';
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="label_text">TICKET LABEL</span>';
	inlineQty +=
		'<select id="label_status" class="form-control label_status" ' +
		labeldisabled +
		">";
	...
	labelResultSet.run().each(function (labelResult) {
		...
		if (selected_label_id == labelId) {
			inlineQty +=
				'<option value="' + labelId + '"selected>' + labelName + "</option>";
		} else {
			inlineQty +=
...
function enquiryMediumSection(
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="enquiry_status_text">ENQUIRY STATUS</span>';
	inlineQty +=
		'<select id="enquiry_status" class="form-control enquiry_status">';
	inlineQty += "<option></option>";
...
function enquiryCountSection(
	...
	if (isNullorEmpty(total_enquiry_count)) {
		total_enquiry_count = 0;
	}
	if (isNullorEmpty(chat_enquiry_count)) {
		chat_enquiry_count = 0;
	}
	if (isNullorEmpty(phone_enquiry_count)) {
		phone_enquiry_count = 0;
	}
	if (isNullorEmpty(email_enquiry_count)) {
		email_enquiry_count = 0;
	}
	if (isNullorEmpty(portal_enquiry_count)) {
		portal_enquiry_count = 0;
	}
	if (isNullorEmpty(phone_interaction_count)) {
		phone_interaction_count = 0;
	}
	if (isNullorEmpty(email_interaction_count)) {
		email_interaction_count = 0;
	}
	...
	var inlineQty =
		'<div class="form-group container enquiry_count_breakdown_section">';
	inlineQty += '<div class="row">';

	inlineQty += '<div class="col-xs-3 enquiry_count_by_chat">';
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="enquiry_count_by_chat_text"> WEBSITE ENQUIRY </span>';
	inlineQty +=
		'<input id="enquiry_count_by_chat" value="' +
		chat_enquiry_count +
		'" class="form-control enquiry_count_by_chat" disabled>';
	inlineQty += '<div class="input-group-btn">';
	inlineQty +=
		'<button type="button" style="background-color: #095C7B" class="btn btn-success increment_enquiry_count_by_chat" data-firstname="" data-toggle="tooltip" data-placement="right" title="Increment Chat Enquiry Count">';
	inlineQty += '<span class="glyphicon glyphicon-plus"></span>';
	inlineQty += "</button>";
	inlineQty +=
		'<button type="button" class="btn btn-danger decrement_enquiry_count_by_chat" data-firstname="" data-toggle="tooltip" data-placement="right" title="Decrement Chat Enquiry Count">';
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="enquiry_count_by_phone_text"> PHONE ENQUIRY </span>';
	inlineQty +=
		'<input id="enquiry_count_by_phone" value="' +
		phone_enquiry_count +
		'" class="form-control enquiry_count_by_phone" disabled>';
	inlineQty += '<div class="input-group-btn">';
	inlineQty +=
		'<button type="button" style="background-color: #095C7B" class="btn btn-success increment_enquiry_count_by_phone" data-firstname="" data-toggle="tooltip" data-placement="right" title="Increment Phone Enquiry Count">';
	inlineQty += '<span class="glyphicon glyphicon-plus"></span>';
	inlineQty += "</button>";
	inlineQty +=
		'<button type="button" class="btn btn-danger decrement_enquiry_count_by_phone" data-firstname="" data-toggle="tooltip" data-placement="right" title="Decrement Phone Enquiry Count">';
	inlineQty += '<span class="glyphicon glyphicon-minus"></span>';
	inlineQty += "</button>";
	inlineQty += "</div></div></div>";
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="enquiry_count_by_portal_text"> PORTAL ENQUIRY </span>';
	inlineQty +=
		'<input id="enquiry_count_by_portal" value="' +
		portal_enquiry_count +
		'" class="form-control enquiry_count_by_portal" disabled>';
	inlineQty += '<div class="input-group-btn">';
	inlineQty +=
		'<button type="button" style="background-color: #095C7B" class="btn btn-success increment_enquiry_count_by_portal" data-firstname="" data-toggle="tooltip" data-placement="right" title="Increment Portal Enquiry Count">';
	inlineQty += '<span class="glyphicon glyphicon-plus"></span>';
	inlineQty += "</button>";
	inlineQty +=
		'<button type="button" class="btn btn-danger decrement_enquiry_count_by_portal" data-firstname="" data-toggle="tooltip" data-placement="right" title="Decrement Portal Enquiry Count">';
	inlineQty += '<span class="glyphicon glyphicon-minus"></span>';
	inlineQty += "</button>";
	inlineQty += "</div></div></div>";
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="enquiry_count_by_email_text"> EMAIL ENQUIRY </span>';
	inlineQty +=
		'<input id="enquiry_count_by_email" value="' +
		email_enquiry_count +
		'" class="form-control enquiry_count_by_email" disabled>';
	inlineQty += '<div class="input-group-btn">';
	inlineQty +=
		'<button type="button" style="background-color: #095C7B" class="btn btn-success increment_enquiry_count_by_email" data-firstname="" data-toggle="tooltip" data-placement="right" title="Increment Email Enquiry Count">';
	inlineQty += '<span class="glyphicon glyphicon-plus"></span>';
	inlineQty += "</button>";
	inlineQty +=
		'<button type="button" class="btn btn-danger decrement_enquiry_count_by_email" data-firstname="" data-toggle="tooltip" data-placement="right" title="Decrement Email Enquiry Count">';
	inlineQty += '<span class="glyphicon glyphicon-minus"></span>';
	inlineQty += "</button>";
	inlineQty += "</div></div></div></div></div>";
	if (selector_type == "customer_issue") {
		inlineQty +=
			'<div class="form-group container interaction_count_breakdown_section">';
		inlineQty += '<div class="row">';

		inlineQty += '<div class="col-xs-6 interaction_count_by_phone">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="interaction_count_by_phone_text"> PHONE INTERACTION </span>';
		inlineQty +=
			'<input id="interaction_count_by_phone" value="' +
			phone_interaction_count +
			'" class="form-control interaction_count_by_phone" disabled>';
		inlineQty += '<div class="input-group-btn">';
		inlineQty +=
			'<button type="button" style="background-color: #095C7B" class="btn btn-success increment_interaction_count_by_phone" data-firstname="" data-toggle="tooltip" data-placement="right" title="Increment Phone Interaction Count">';
		inlineQty += '<span class="glyphicon glyphicon-plus"></span>';
		inlineQty += "</button>";
		inlineQty +=
			'<button type="button" class="btn btn-danger decrement_interaction_count_by_phone" data-firstname="" data-toggle="tooltip" data-placement="right" title="Decrement Phone interaction Count">';
		inlineQty += '<span class="glyphicon glyphicon-minus"></span>';
		inlineQty += "</button>";
		inlineQty += "</div></div></div>";

		inlineQty += '<div class="col-xs-6 interaction_count_by_email">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="interaction_count_by_email_text"> EMAIL INTERACTION </span>';
		inlineQty +=
			'<input id="interaction_count_by_email" value="' +
			email_interaction_count +
			'" class="form-control interaction_count_by_email" disabled>';
		inlineQty += '<div class="input-group-btn">';
		inlineQty +=
			'<button type="button" style="background-color: #095C7B" class="btn btn-success increment_interaction_count_by_email" data-firstname="" data-toggle="tooltip" data-placement="right" title="Increment Email Interaction Count">';
		inlineQty += '<span class="glyphicon glyphicon-plus"></span>';
		inlineQty += "</button>";
		inlineQty +=
			'<button type="button" class="btn btn-danger decrement_interaction_count_by_email" data-firstname="" data-toggle="tooltip" data-placement="right" title="Decrement Email Interaction Count">';
		inlineQty += '<span class="glyphicon glyphicon-minus"></span>';
		inlineQty += "</button>";
		inlineQty += "</div></div></div></div></div>";
	}
 ...
 * @return  {String} inlineQty
 */
function otherInvoiceFieldsSection(
	selected_invoice_method_id,
	accounts_cc_email,
	mpex_po_number,
	customer_po_number,
	...
	switch (selector_type) {
		case "barcode_number":
			var inlineQty =
				'<div class="form-group container invoice_method_accounts_cc_email_section hide">';
			var disabled = "disabled";
			break;
	...
	inlineQty +=
		'<select id="invoice_method" class="form-control" ' + disabled + ">";
	inlineQty += "<option></option>";
	...
	inlineQty +=
		'<input id="accounts_cc_email" type="email" value="' +
		accounts_cc_email +
		'" class="form-control accounts_cc_email"  ' +
		disabled +
		"/>";
	inlineQty += '<div class="input-group-btn">';
	inlineQty +=
	...
	switch (selector_type) {
		case "barcode_number":
			inlineQty +=
				'<div class="form-group container mpex_customer_po_number_section hide">';
			break;
	...
	inlineQty +=
		'<input id="mpex_po_number" value="' +
		mpex_po_number +
		'" class="form-control mpex_po_number"  ' +
		disabled +
		"/>";
	inlineQty += "</div></div>";
	// Customer PO #
	...
	inlineQty +=
		'<input id="customer_po_number" value="' +
		customer_po_number +
		'" class="form-control customer_po_number"  ' +
		disabled +
		"/>";
	inlineQty += "</div></div></div></div>";
	...
	inlineQty +=
		'<input id="terms" class="form-control terms" value="' +
		terms_text +
		'" disabled/>';
	inlineQty += "</div></div>";
	...
	switch (selector_type) {
		case "barcode_number":
			inlineQty +=
				'<div class="form-group container mpex_invoicing_cycle_section hide">';
			break;
...
function attachmentsSection(attachments_hyperlink, status_value) {
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="attachments_text">ATTACHMENTS</span>';
	inlineQty +=
		'<input id="attachments" class="form-control attachments" type="url" value="' +
		attachments_hyperlink +
		'" ' +
		disabled +
		"/>";
...
function mpexContactSection() {
	...
	inlineQty += '<div class="col-xs-12 heading2">';
	inlineQty +=
		'<h4><span style="background-color: #095C7B" class="label label-default col-xs-12">CONTACT DETAILS</span></h4>';
	inlineQty += "</div>";
	inlineQty += "</div></div>";

	// Contact table
	inlineQty +=
		'<div class="form-group container contacts_section" style="font-size: small;">';
	inlineQty += '<div class="row">';
	...
	inlineQty +=
		'<input type="button" style="background-color: #095C7B; border-color: #095C7B; font-weight: 700" value="ADD/EDIT CONTACTS" class="form-control btn btn-primary" id="reviewcontacts" />';
	inlineQty += "</div></div></div>";
...
function openInvoicesSection(ticket_id, selector_type) {
	...
	inlineQty += '<div class="col-xs-12 heading2">';
	inlineQty +=
		'<h4><span style="background-color: #095C7B" class="label label-default col-xs-12">OPEN INVOICES</span></h4>';
	inlineQty += "</div></div></div>";
	...
	//inlineQty += '</div>';
	inlineQty +=
		'<div class="form-group open_invoices open_invoices_table ' +
		hide_class_section +
		'">';
	inlineQty += dataTable();
	// inlineQty += '<div class="row">';
...
function dataTable() {
	var inlineQty =
		"<style>table#invoices-preview {font-size: 12px;text-align: center;border: none;}.dataTables_wrapper {font-size: 14px;}table#invoices-preview th{text-align: center;} .bolded{font-weight: bold;}</style>";
	inlineQty +=
		'<table id="invoices-preview" class="table table-responsive table-striped customer tablesorter" style="width: 100%; table-layout: fixed">';
	inlineQty += '<thead style="color: white;background-color: #095C7B;">';
	inlineQty += '<tr class="text-center">';
	inlineQty += "</tr>";
	inlineQty += "</thead>";
...
function creditMemoSection(selector_type) {
	...
	if (selector_type == "invoice_number") {
		// Credit Memo Header
		inlineQty +=
			'<div class="form-group container credit_memo credit_memo_header">';
		inlineQty += '<div class="row">';
		inlineQty += '<div class="col-xs-12 heading2">';
		inlineQty +=
			'<h4><span style="background-color: #095C7B" class="label label-default col-xs-12">CREDIT MEMO</span></h4>';
		inlineQty += "</div></div></div>";
		// Credit Memo table
		inlineQty +=
			'<div class="form-group container credit_memo credit_memo_section" style="font-size: small;">';
		inlineQty += '<div class="row">';
...
function usageReportSection(selector_type) {
	...
	if (selector_type == "invoice_number") {
		// Usage Report Header
		inlineQty +=
			'<div class="form-group container usage_report usage_report_header">';
		inlineQty += '<div class="row">';
		inlineQty += '<div class="col-xs-12 heading2">';
		inlineQty +=
			'<h4><span style="background-color: #095C7B" class="label label-default col-xs-12">USAGE REPORT</span></h4>';
		inlineQty += "</div></div></div>";
		// Usage Report table
		inlineQty +=
			'<div class="form-group container usage_report usage_report_section" style="font-size: small;">';
		inlineQty += '<div class="row">';
...
function sendEmailSection(
	...
	// Row addressees
	inlineQty +=
		'<div class="form-group container send_email adressees_section">';
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 to_section">';
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon">TO<span class="mandatory">*</span></span>';
	inlineQty +=
		'<input id="send_to" class="form-control" data-contact-id="" data-firstname=""/>';
	inlineQty += "</div></div></div></div>";
	...
	inlineQty +=
		'<div class="form-group container send_email toll_adressees_section">';
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 toll_section">';
	inlineQty += '<div class="input-group">';
	inlineQty += '<span class="input-group-addon">TOLL EMAILS</span>';
	inlineQty +=
		'<select multiple id="send_toll" class="form-control" size="' +
		tollEmailsResultSet.length +
		'"/>';
	...
	tollEmailsResultSet.run().each(function (tollEmailsResultSet) {
		...
		if (selected) {
			...
			inlineQty +=
				'<option value="' + tollEmailId + '">' + tollEmailName + "</option>";
		}
		return true;
	});
	...
	// Row ccs addresses
	inlineQty +=
		'<div class="form-group container send_email cc_adressees_section">';
	inlineQty += '<div class="row">';
	...
	if (!isNullorEmpty(account_manager.email.email)) {
		inlineQty +=
			'<div class="form-group container send_email acc_manager_section">';
		inlineQty += '<div class="row">';
		inlineQty += '<div class="col-xs-10 acc_manager_name_section">';
		inlineQty += '<div class="input-group">';
		inlineQty += '<span class="input-group-addon">ACCOUNT MANAGER</span>';
		inlineQty +=
			'<input id="acc_manager" class="form-control" data-email="' +
			account_manager.email.email +
			'" value="' +
			account_manager.name +
			" - " +
			account_manager.email.email +
		...
		inlineQty +=
			'<button id="acc_manager_button" style="background-color: #095C7B; border-color: #095C7B" type="button" class="btn btn-success btn-block">ADD TO CC</button>';
		inlineQty += "</div></div></div>";
	}

	// Row Template
	inlineQty +=
		'<div class="form-group container send_email template_section">';
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 template_section">';
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon">TEMPLATE<span class="mandatory">*</span></span>';
	...
	// Row Subject
	inlineQty +=
		'<div class="form-group container send_email subject_section">';
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 subject_section">';
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon">SUBJECT<span class="mandatory">*</span></span>';
	...
	inlineQty +=
		'<input type="button" style="background-color: #095C7B; border-color: #095C7B; font-weight: 700" value="SEND EMAIL" class="form-control btn btn-primary" id="send_email" />';
	inlineQty += "</div></div></div></div>";
...
function previousEmailsSection(customer_id) {
	...
	inlineQty += '<div class="col-xs-12 heading2">';
	inlineQty +=
		'<h4><span style="background-color: #095C7B" class="label label-default col-xs-12">PREVIOUS EMAILS</span></h4>';
	inlineQty += "</div></div></div>";
	...
	var emailSearch = search.load({
		type: "message",
		id: "customsearch_all_messages",
	});
	var emailSearchFilter = [
		["customer.internalid", "anyof", customer_internal_id],
		"AND",
		["messagedate", "after", "lastmonthonefiscalquarterago"],
	]; //670041, 313070
	...
	inlineQty +=
		"<style>table#emails-preview {font-size: 12px;text-align: center;border: none; background-color: #095C7B}.dataTables_wrapper {font-size: 12px;}table#emails-preview th{background-color: #095C7B; text-align: center;}</style>";
	inlineQty +=
		'<table cellpadding="15" id="emails-preview" class="table table-responsive table-striped customer tablesorter" cellspacing="0" style="width: 100%;">';
	inlineQty += '<thead style="color: white;background-color: #095C7B;">';
	inlineQty += '<tr class="text-center">';
	inlineQty += '<th scope="col">Message Date</th>';
	inlineQty += '<th scope="col">Author</th>';
	...
	allEmails.forEach(function (email) {
		...
		var url =
			"https://1048144-sb3.app.netsuite.com/app/crm/common/crmmessage.nl?id=" +
			messageid;
...
function issuesHeader() {
	var inlineQty =
		'<div class="form-group container toll_issues_header_section">';
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 heading1">';
	inlineQty +=
		'<h4><span style="background-color: #095C7B" class="form-group label label-default col-xs-12">ISSUES</span></h4>';
	inlineQty += "</div></div></div>";
	return inlineQty;
}
...
function reminderSection(status_value) {
	...
	var inlineQty =
		'<div class="form-group container reminder_section ' + hide_class + '">';
	inlineQty += '<div class="row">';
	// Reminder field
	inlineQty += '<div class="col-xs-12 reminder">';
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="reminder_text">REMINDER</span>';
	inlineQty +=
...
function ownerSection(ticket_id, owner_list, status_value) {
	...
	inlineQty +=
		'<select multiple id="owner" class="form-control owner" ' +
		disabled +
		">";
...
function customerIssueDropdown() {
	...
	var inlineQty =
		'<div class="form-group container customer_issues_dropdown_section">';
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12">';

	inlineQty +=
		'<div class="input-group"><span class="input-group-addon">CUSTOMER ISSUE</span>';
...
function customerIssuesSection(
	ticket_id,
	selector_type,
	selector_number,
	screenshot_file,
	...
	if (isNullorEmpty(screenshot_file)) {
		screenshot_file = "";
	}
	if (isNullorEmpty(selected_browser)) {
		selected_browser = "";
	}
	if (isNullorEmpty(login_email_used)) {
		login_email_used = "";
	}
	if (isNullorEmpty(selected_operating_system)) {
		operating_system = "";
	}
	if (isNullorEmpty(phone_used)) {
		phone_used = "";
	}
	if (isNullorEmpty(old_sender_name)) {
		old_sender_name = "";
	}
	if (isNullorEmpty(old_sender_phone)) {
		old_sender_phone = "";
	}

	var hide_class_section_mp_app =
		selector_type == "customer_issue" && selector_number == "Customer App"
			? ""
			: "hide";
	var hide_class_section_mp_label =
		selector_type == "customer_issue" && selector_number == "Update Label"
			? ""
			: "hide";
	var is_customer_issue_hide =
		selector_type != "customer_issue" ? "hide" : "";
	var hide_class_section_mp_portal =
		selector_type == "customer_issue" && selector_number == "Customer Portal"
			? ""
			: "hide";
	...
	if (
		...
		(selector_number == "Customer App" ||
			selector_number == "Customer Portal") &&
		!isNullorEmpty(ticket_id)
	) {
		...
		inlineQty +=
			'<div class="input-group"><span class="input-group-addon" id="screenshot_text">SCREENSHOT</span>';
		inlineQty +=
			'<input type="file" class="form-control" id="screenshot_image" value="' +
			screenshot_file +
			'">';
		inlineQty += "</div></div></div></div>";
	}
	...
	inlineQty +=
		'<div class="form-group container browser_os_section ' +
		hide_class_section_mp_portal +
		" " +
		is_customer_issue_hide +
		'">';
	inlineQty += '<div class="row">';

	inlineQty += '<div class="col-xs-6 browser_div">';
	inlineQty +=
		'<div class="input-group"><span class="input-group-addon" id="browser_text">BROWSER</span>';
	inlineQty +=
		'<select id="browser_value" class="form-control label_status">';
	inlineQty += "<option></option>";
	...
	var browserResultSet = search.create({
		type: "customlist_common_browsers",
	...
	browserResultSet.run().each(function (browserResult) {
		...
		if (selected_browser == browserId) {
			...
			inlineQty +=
				'<option value="' + browserId + '">' + browserName + "</option>";
		}
		return inlineQty;
	});
	...
	inlineQty +=
		'<div class="input-group"><span class="input-group-addon" id="os_text">OPERATING SYSTEM</span>';
	...
	var osResultSet = search.create({
		type: "customlist_common_os",
		columns: osColumns,
	});
	...
	osResultSet.run().each(function (osResult) {
		...
		if (selected_browser == osId) {
			inlineQty +=
				'<option value="' + osId + '"selected>' + osName + "</option>";
		} else {
	...
	inlineQty +=
		...
		is_customer_issue_hide +
		" phone_section " +
		hide_class_section_mp_app +
		'">';
	inlineQty += '<div class="row">';

	inlineQty += '<div class="col-xs-12 phone_div">';
	inlineQty +=
		'<div class="input-group"><span class="input-group-addon" id="screenshot_text">PHONE</span>';
	inlineQty +=
		'<input type="text" class="form-control" id="phone_used" placeholder=" Google Pixel 3" value="' +
		phone_used +
		'">';
	inlineQty += "</div></div></div></div>";
	...
	inlineQty +=
		'<div class="form-group container login_email_used_section ' +
		is_customer_issue_hide +
		'">';
	inlineQty += '<div class="row">';
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="login_email">LOGIN EMAIL</span>';

	inlineQty +=
		'<input id="login_email_text" class="form-control" value="' +
		login_email_used +
		'"/>';
	inlineQty += "</div></div></div></div>";
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="sender_name">SENDER NAME</span>';
	inlineQty +=
		'<input id="sender_name_text" class="form-control" value="' +
		old_sender_name +
		'"/>';
	inlineQty += "</div></div>";
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="sender_phone">SENDER PHONE</span>';
	inlineQty +=
		'<input id="sender_phone_text" class="form-control" value="' +
		old_sender_phone +
		'"/>';
	inlineQty += "</div></div></div></div>";
...
function tollIssuesSection(
	...
	if (!isTicketNotClosed(status_value) || selector_type != "barcode_number") {
		var inlineQty =
			'<div class="form-group container toll_issues_section hide">';
	} else {
	...
	inlineQty +=
		'<div class="input-group"><span class="input-group-addon" id="toll_issues_text">TOLL ISSUES<span class="mandatory">*</span></span>';
	inlineQty +=
		'<select multiple id="toll_issues" class="form-control toll_issues" size="' +
		tollIssuesResultSet.length +
		'">';
	...
	tollIssuesResultSet.run().each(function (tollIssueResult) {
		...
		if (selected) {
			...
			inlineQty +=
				'<option value="' + issue_id + '">' + issue_name + "</option>";
		}
		return true;
	});
	...
	log.debug({
		title: "list_resolved_toll_issues : ",
		details: list_resolved_toll_issues,
	});
	...
	if (has_resolved_toll_issues) {
		...
		log.debug({
			title: "text_resolved_toll_issues : ",
			details: text_resolved_toll_issues,
		});
		inlineQty +=
			'<div class="form-group container resolved_toll_issues_section">';
		inlineQty += '<div class="row">';
		inlineQty += '<div class="col-xs-12 resolved_toll_issues">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="resolved_toll_issues_text">RESOLVED TOLL ISSUES</span>';
		inlineQty +=
			'<textarea id="resolved_toll_issues" class="form-control resolved_toll_issues" rows="' +
			list_resolved_toll_issues.length +
			'" disabled>' +
			text_resolved_toll_issues.trim() +
			"</textarea>";
		inlineQty += "</div></div></div></div>";
	}
...
/**
 * The multiselect OPERATION issues dropdown
 * @param   {Array}     list_toll_issues
 * @param   {Array}     list_resolved_toll_issues
 * @param   {Number}    status_value
 * @param   {String}    selector_type
 * @return  {String}    inlineQty
 */
function operationsIssuesSection(
	list_operation_issues,
	list_resolved_operation_issues,
	status_value,
	selector_type
	...
	operation_issues_columns[1] = search.createColumn({ name: "internalId" });
	...
	if (
		...
		var inlineQty =
			'<div class="form-group container operation_issues_section">';
	}
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 operation_issues">';
	inlineQty +=
		'<div class="input-group"><span class="input-group-addon" id="operation_issues_text">OPERATION ISSUES<span class="mandatory">*</span></span>';
	inlineQty +=
		'<select multiple id="operation_issues" class="form-control operation_issues" size="' +
		operationIssuesResultSet.length +
		'">';

	operationIssuesResultSet.run().each(function (operationIssueResult) {
		var issue_name = operationIssueResult.getValue("name");
		var issue_id = operationIssueResult.getValue("internalId");
		var selected = false;
		if (has_operation_issues) {
			selected = list_operation_issues.indexOf(issue_id) !== -1;
		}
	...
	var has_resolved_operation_issues = !isNullorEmpty(
		list_resolved_operation_issues
	);
	if (has_resolved_operation_issues) {
		var text_resolved_operation_issues = "";
		operationIssuesResultSet.run().each(function (operationIssueResult) {
			var issue_name = operationIssueResult.getValue("name");
			var issue_id = operationIssueResult.getValue("internalId");
			if (list_resolved_operation_issues.indexOf(issue_id) !== -1) {
				text_resolved_operation_issues += issue_name + "\n";
			}
			return true;
		});
		log.debug({
			title: "text_resolved_operation_issues : ",
			details: text_resolved_operation_issues,
		});
		inlineQty +=
			'<div class="form-group container resolved_operation_issues_section">';
		inlineQty += '<div class="row">';
		inlineQty += '<div class="col-xs-12 resolved_operation_issues">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="resolved_toll_issues_text">RESOLVED OPERATION ISSUES</span>';
		inlineQty +=
			'<textarea id="resolved_operation_issues" class="form-control resolved_operation_issues" rows="' +
			list_resolved_operation_issues.length +
			'" disabled>' +
			text_resolved_operation_issues.trim() +
			"</textarea>";
		inlineQty += "</div></div></div></div>";
	}
 ...
 * @return  {String}    inlineQty
 */
function mpTicketIssuesSection(
	list_mp_ticket_issues,
	list_resolved_mp_ticket_issues,
	status_value,
	selector_type
	...
	var disabled_mp_issue_field = isTicketNotClosed(status_value)
		? ""
		: "disabled";
	log.debug({
		title: "has_mp_ticket_issues : ",
		details: has_mp_ticket_issues,
	});
	...
	if (has_mp_ticket_issues && status_value != 3) {
		...
		var inlineQty =
			'<div class="form-group container mp_issues_section hide">';
	}
	inlineQty += '<div class="row">';
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="mp_issues_text">MP ISSUES<span class="mandatory hide">*</span></span>';
	inlineQty +=
		'<select multiple id="mp_issues" class="form-control mp_issues" size="' +
		mpTicketIssuesResultSet.length +
		'" ' +
		disabled_mp_issue_field +
		">";
	...
	mpTicketIssuesResultSet.run().each(function (mpTicketIssueResult) {
		...
		var show_option =
			selector_type == "barcode_number" ||
			(selector_type == "invoice_number" && mp_issue_id == 4) ||
			selector_type == "customer_issue";
	...
	var has_resolved_mp_ticket_issues = !isNullorEmpty(
		list_resolved_mp_ticket_issues
	);
	if (has_resolved_mp_ticket_issues && selector_type != "customer_issue") {
		...
		inlineQty +=
			'<div class="form-group container resolved_mp_issues_section">';
		inlineQty += '<div class="row">';
		inlineQty += '<div class="col-xs-12 resolved_mp_issues">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="resolved_mp_issues_text">RESOLVED MP ISSUES</span>';
		inlineQty +=
			'<textarea id="resolved_mp_issues" class="form-control resolved_mp_issues" rows="' +
			list_resolved_mp_ticket_issues.length +
			'" disabled>' +
			text_resolved_mp_ticket_issues.trim() +
			"</textarea>";
		inlineQty += "</div></div></div></div>";
	}
...
function invoiceIssuesSection(
	...
	var invoiceIssuesResultSet = search.create({
		type: "customlist_invoice_issues",
		columns: invoice_issues_columns,
	});

	if (!isTicketNotClosed(status_value) || selector_type != "invoice_number") {
		var inlineQty =
			'<div class="form-group container invoice_issues_section hide">';
	} else {
		var inlineQty =
			'<div class="form-group container invoice_issues_section">';
	}
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 invoice_issues">';
	inlineQty +=
		'<div class="input-group"><span class="input-group-addon" id="invoice_issues_text">INVOICE ISSUES<span class="mandatory">*</span></span>';
	inlineQty +=
		'<select multiple id="invoice_issues" class="form-control invoice_issues">';
	...
	log.debug({
		title: "list_resolved_invoice_issues : ",
		details: list_resolved_invoice_issues,
	});
	var has_resolved_invoice_issues = !isNullorEmpty(
		list_resolved_invoice_issues
	);
	if (has_resolved_invoice_issues) {
		...
		log.debug({
			title: "text_resolved_invoice_issues : ",
			details: text_resolved_invoice_issues,
		});
		inlineQty +=
			'<div class="form-group container resolved_invoice_issues_section">';
		inlineQty += '<div class="row">';
		inlineQty += '<div class="col-xs-12 resolved_invoice_issues">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="resolved_invoice_issues_text">RESOLVED INVOICE ISSUES</span>';
		inlineQty +=
			'<textarea id="resolved_invoice_issues" class="form-control resolved_invoice_issues" rows="' +
			list_resolved_invoice_issues.length +
			'" disabled>' +
			text_resolved_invoice_issues.trim() +
			"</textarea>";
		inlineQty += "</div></div></div></div>";
	}
...
function usernoteSection(selector_type, status_value) {
	...
	var usernoteTitlesResultSet = search.create({
		type: "customlist_user_note_title",
		columns: usernote_titles_columns,
	});

	// Row Title
	if (selector_type == "invoice_number" && isTicketNotClosed(status_value)) {
		var inlineQty =
			'<div class="form-group container user_note user_note_title_section">';
	} else {
		var inlineQty =
			'<div class="form-group container user_note user_note_title_section hide">';
	}
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 user_note_title_section">';
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon">TITLE<span class="mandatory">*</span></span>';
	...
	if (selector_type == "invoice_number" && isTicketNotClosed(status_value)) {
		inlineQty +=
			'<div class="form-group container user_note user_note_textarea_section">';
	} else {
		inlineQty +=
			'<div class="form-group container user_note user_note_textarea_section hide">';
	}
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 user_note_textarea">';
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="user_note_textarea_text">USER NOTE<span class="mandatory hide">*</span></span>';
	inlineQty +=
		'<textarea id="user_note_textarea" class="form-control user_note_textarea" rows="3"></textarea>';
	inlineQty += "</div></div></div></div>";

	// User Note table
	if (selector_type == "invoice_number") {
		inlineQty +=
			'<div class="form-group container user_note user_note_section" style="font-size: small;">';
	} else {
		inlineQty +=
			'<div class="form-group container user_note user_note_section hide" style="font-size: small;">';
	}
	inlineQty += '<div class="row">';
...
function commentSection(comment, selector_type, status_value) {
	...
	switch (selector_type) {
		...
		case "invoice_number":
			var inlineQty =
				'<div class="form-group container comment_section hide">';
			break;
		case "customer_issue":
			var inlineQty = '<div class="form-group container comment_section">';
			break;
	...
	inlineQty += '<div class="input-group">';
	inlineQty +=
		'<span class="input-group-addon" id="comment_text">COMMENT<span class="mandatory hide">*</span></span>';
	if (isTicketNotClosed(status_value)) {
		inlineQty +=
			'<textarea id="comment" class="form-control comment" rows="9">' +
			comment +
			"</textarea>";
	} else {
		inlineQty +=
			'<textarea id="comment" class="form-control comment" rows="9" readonly>' +
			comment +
			"</textarea>";
	}
	inlineQty += "</div></div></div></div>";
...
function dataTablePreview() {
	var inlineQty =
		'<div class="form-group container tickets_datatable_section">';
	inlineQty += '<div class="row">';
	inlineQty += '<div class="col-xs-12 heading2">';
	inlineQty +=
		'<h4><span style="background-color: #095C7B" class="label label-default col-xs-12">PREVIOUS TICKETS</span></h4>';
	inlineQty += "</div></div></div>";
	inlineQty +=
		"<style>table#tickets-preview {font-size: 12px;text-align: center;border: none; background-color: #095C7B}.dataTables_wrapper {font-size: 12px;}table#tickets-preview th{background-color: #095C7B; text-align: center;}</style>";
	inlineQty +=
		'<table cellpadding="15" id="tickets-preview" class="table table-responsive table-striped customer tablesorter" cellspacing="0" style="width: 100%;">';
	inlineQty += '<thead style="color: white;background-color: #095C7B;">';
	inlineQty += '<tr class="text-center">';
	inlineQty += "</tr>";
	inlineQty += "</thead>";
...
function closeReopenSubmitTicketButton(ticket_id, status_value) {
	var inlineQty =
		'<div class="form-group container close_reopen_submit_ticket_section">';
	inlineQty += '<div class="row">';
	...
	if (isTicketNotClosed(status_value)) {
		if (!isNullorEmpty(ticket_id)) {
			...
			inlineQty +=
				'<input type="button" value="CLOSE TICKET" style="background-color: #FBEA51; border: 3px solid #095C7B; color: #095C7B; font-weight: 700" class="form-control btn btn-default" id="close_ticket" onclick="closeTicket()"/>';
			inlineQty += "</div>";
			inlineQty += '<div class="col-xs-3 close_ticket_lost">';
			inlineQty +=
				'<input type="button" value="CLOSE TICKET - LOST ITEM" style="background-color: #FBEA51; border: 3px solid #095C7B; color: #095C7B; font-weight: 700" class="form-control btn btn-default" id="close_ticket_lost" onclick="closeTicketLost()"/>';
			inlineQty += "</div>";
			if (userId == 409635 || userId == 696992 || userId == 766498) {
				inlineQty += '<div class="col-xs-3 close_unallocated_ticket hide">';
				inlineQty +=
					'<input type="button" value="CLOSE UNALLOCATED TICKET" style="background-color: #FBEA51; border: 3px solid #095C7B; color: #095C7B; font-weight: 700" class="form-control btn btn-default" id="close_unallocated_ticket" onclick="closeUnallocatedTicket()" />';
				inlineQty += "</div>";
			}
		}
		...
		inlineQty +=
			'<input type="button" style="background-color: #FBEA51; border: 3px solid #095C7B; color: #095C7B; font-weight: 700" value="UPDATE TICKET" class="form-control btn btn-primary" id="submit_ticket" />';
		inlineQty += "</div>";

		if (isNullorEmpty(ticket_id)) {
			inlineQty += '<div class="col-xs-3 open_and_new_ticket_btn">';
			inlineQty +=
				'<input type="button" style="background-color: #FBEA51; border: 3px solid #095C7B; color: #095C7B; font-weight: 700" value="OPEN AND NEW TICKET" class="form-control btn btn-primary" id="open_and_new_ticket_btn" />';
			inlineQty += "</div>";
		}
		inlineQty +=
			"<style>.escalate:hover {box-shadow: 0 12px 16px 0 rgba(0,0,0,0.24), 0 17px 50px 0 rgba(0,0,0,0.19)}</style>";
		inlineQty += '<div class="col-xs-2 escalate">';
		inlineQty +=
			'<input type="button" style="background-color: #FBEA51; border: 3px solid #095C7B; color: #095C7B; font-weight: 700" value="ESCALATE" class="form-control btn btn-default" id="escalate" onclick="onEscalate()"/>';
		inlineQty += "</div>";
	} else {
		inlineQty += '<div class="col-xs-2 col-xs-offset-2 reopen_ticket">';
		inlineQty +=
			'<input type="button" style="background-color: #FBEA51; border: 3px solid #095C7B; color: #095C7B; font-weight: 700" value="REOPEN TICKET" class="form-control btn btn-primary" id="reopen_ticket" />';
		inlineQty += "</div>";
	}
	inlineQty += '<div class="col-xs-2 cancel">';
	inlineQty +=
		'<input type="button" style="background-color: #FBEA51; border: 3px solid #095C7B; color: #095C7B; font-weight: 700" value="CANCEL" class="form-control btn btn-default" id="cancel" onclick="onCancel()"/>';
	inlineQty += "</div>";
...
function isTicketNotClosed(status_value) {
	var is_ticket_not_closed =
		status_value != 3 && status_value != 8 && status_value != 15
			? true
			: false;
