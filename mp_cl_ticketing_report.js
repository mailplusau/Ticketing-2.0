...
define(['N/error', 'N/runtime', 'N/search', 'N/url', 'N/record', 'N/format',
  ...
  function(error, runtime, search, url, record, format, email, currentRecord) {
    ...
    function barcodeSourceChart(date_from, date_to) {
      ...
      console.log('MPEX Shopify Source')
      console.log(mpex_shopify_source)
      console.log('Shopify Source Tickets')
      console.log(shopify_source_tickets)

      console.log('MPEX Portal Source')
      console.log(mpex_portal_source)
      console.log('Portal Source Tickets')
      console.log(portal_source_tickets)

      console.log('MPEX Bulk Source')
      console.log(mpex_bulk_source)
      console.log('Bulk Source Tickets')
      console.log(bulk_source_tickets)
