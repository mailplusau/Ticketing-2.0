  ...
  define(['N/ui/serverWidget', 'N/email', 'N/runtime', 'N/search', 'N/record',
    ...
    function(ui, email, runtime, search, record, http, log, redirect, format) {
      ...
      function tabsSection() {
        ...
        inlineQty += '<div class="tab-content">';
        inlineQty +=
          '<div role="tabpanel" class="tab-pane active" id="ticketsOverview">';
        inlineQty += '<figure class="highcharts-figure">';
        inlineQty += '<div id="container"></div>';
        inlineQty += '</figure><br></br>';
        inlineQty += dataTable('preview');
        ...
        inlineQty +=
          '<li role="presentation" class="active"><a data-toggle="tab" href="#ticketBarcodeSource"><b>TICKET BARCODE SOURCE</b></a></li>';
        inlineQty +=
          '<li role="presentation" class=""><a data-toggle="tab" href="#ticketvsScannedBarcodeSource"><b>TICKET BARCODE SOURCE vs SCANNED BARCODE SOURCE (%)</b></a></li>';
        inlineQty += '</ul></div>';

        // Tabs content
        inlineQty += '<div class="tab-content">';
        inlineQty +=
          '<div role="tabpanel" class="tab-pane active" id="ticketBarcodeSource">';
        inlineQty += '<figure class="highcharts-figure">';
        ...
        inlineQty +=
          '<div role="tabpanel" class="tab-pane" id="ticketvsScannedBarcodeSource">';
        inlineQty += '<figure class="highcharts-figure">';
        inlineQty += '<div id="container7"></div>';
        inlineQty += '</figure><br></br>';
        inlineQty += '</div>';
      ...
      function dataTable(name) {
        ...
        inlineQty +=
          '<thead style="color: white;background-color: #379E8F;">';
      ...
      function periodDropdownSection(date_from, date_to) {
        ...
        inlineHtml +=
          '<option value="full_year">Full Year (1 Jan -)</option>';
        inlineHtml +=
