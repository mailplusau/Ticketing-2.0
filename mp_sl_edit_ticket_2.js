...
define([
	...
	function onRequest(context) {
		if (context.request.method === "GET") {
			...
			if (!isNullorEmpty(params)) {
				...
				inlineHtml +=
					'<link type="text/css" href="https://cdn.datatables.net/fixedheader/3.1.7/css/fixedHeader.dataTables.min.css" rel="stylesheet" />';
				inlineHtml +=
				...
				inlineHtml +=
					'<button style="margin-left: 10px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="opennewticket" onclick="">Open New Ticket</button>';
				inlineHtml +=
					'<button style="margin-left: 5px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="viewclosedtickets" onclick="">View Closed Tickets</button>';
				inlineHtml +=
					'<button style="margin-left: 5px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="viewlosttickets" onclick="">View Lost Tickets</button>';
				inlineHtml +=
					'<button style="margin-left: 5px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="sendbulkemails" onclick="">Send Bulk Emails</button>';
				inlineHtml +=
					'<button style="margin-left: 5px; margin-right: 5px; background-color: #FBEA51; color: #103D39; font-weight: 700; border-color: transparent; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="bulkescalatebtn" onclick="">Bulk Escalate</button>';

				inlineHtml +=
					'<h1 style="font-size: 25px; font-weight: 700; color: #103D39; text-align: center">View MP Tickets</h1>';
				...
				inlineHtml +=
					"<style> .loader { border: 14px solid #f3f3f3; border-radius: 50%; border-top: 14px solid #095C7B; width: 90px; height: 90px; -webkit-animation: spin 2s linear infinite; /* Safari */ animation: spin 2s linear infinite;";
			...
			var param_selected_ticket_id =
				context.request.parameters.custpage_selected_id;
			var param_escalate_ticket_id =
	...
	function dateCreatedSection() {
		var inlineQty =
			'<div class="form-group container date_filter_section" style="margin-top:40px; margin-bottom: 60px">';
		inlineQty += '<div class="row">';
		// Date from field
		inlineQty += '<div class="col-xs-6 date_from">';
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="date_from_text">DATE CREATED FROM</span>';
		inlineQty +=
		...
		inlineQty += '<div class="input-group">';
		inlineQty +=
			'<span class="input-group-addon" id="date_to_text">DATE CREATED TO</span>';
		inlineQty +=
	...
	function tabsSection(userRole) {
		...
		if (isFinanceRole(userRole)) {
			inlineQty +=
				'<li role="presentation" class=""><a data-toggle="tab" href="#barcodes"><b>BARCODES</b></a></li>';
			inlineQty +=
				'<li role="presentation" class=""><a data-toggle="tab" href="#customers"><b>CUSTOMERS</b></a></li>';
			inlineQty +=
				'<li role="presentation" class="active"><a data-toggle="tab" href="#operations"><b>OPERATIONS</b></a></li>';
			...
			inlineQty +=
				'<li role="presentation" class="active"><a data-toggle="tab" href="#barcodes"><b>BARCODES</b></a></li>';
			inlineQty +=
				'<li role="presentation" class=""><a data-toggle="tab" href="#customers"><b>CUSTOMERS</b></a></li>';
			inlineQty +=
				'<li role="presentation" class=""><a data-toggle="tab" href="#operations"><b>OPERATIONS</b></a></li>';
			// inlineQty += '<li role="presentation" class=""><a data-toggle="tab" href="#invoices"><b>INVOICES</b></a></li>';
		} else {
			inlineQty +=
				'<li role="presentation" class="active"><a data-toggle="tab" href="#barcodes"><b>BARCODES</b></a></li>';
		...
		if (!isFinanceRole(userRole)) {
			inlineQty +=
				'<div role="tabpanel" class="tab-pane active" id="barcodes">';
	...
	function dataTablePreview(selector) {
		var inlineQty =
			"<style>table#tickets-preview-" +
			selector +
			" {font-size: 12px;text-align: center;border: none;}.dataTables_wrapper {font-size: 14px; }table#tickets-preview-" +
			selector +
			" th{text-align: center;} .bolded{font-weight: bold;}</style>";
		inlineQty += '<div style="width: 95%; margin: auto">';
		inlineQty +=
			'<table id="tickets-preview-' +
			selector +
		...
		inlineQty +=
			'<tbody id="result_tickets_' +
			selector +
			'" style="word-break: break-word;"></tbody>';
