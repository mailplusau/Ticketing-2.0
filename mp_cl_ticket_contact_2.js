    ...
    function(error, runtime, search, url, record, format, email, currentRecord) {
        ...
        function pageInit() {
            ...
            $('#add_edit_contact').click(function () {
                var contact_id = currRec.getValue({ fieldId: 'custpage_contact_id' });
                var row_id = currRec.getValue({ fieldId: 'custpage_row_id' });
            ...
            $('.edit_class').click(function () {
                ...
                currRec.setValue({ fieldId: 'custpage_contact_id', value: contact_id });
                currRec.setValue({ fieldId: 'custpage_row_id', value: row_id });
        ...
        function saveRecord(context) {
            var currRec = currentRecord.get();
            var params = currRec.getValue({ fieldId: 'custpage_params' });
            ...
            $('#contacts tbody tr').each(function () {
                ...
                if (to_delete) {
                    ...
                    if (!isNullorEmpty(contact_id)) {
                        var contactRecord = record.load({ type: record.Type.CONTACT, value: contact_id });
                        contactRecord.setValue({ fieldId: 'isinactive', value: 'T' });
                        contactRecord.save({
                            enableSourcing: true,
                        });
                    ...
                    // Set record values
                    contactRecord.setValue({ fieldId: 'salutation', value: salutation_val });
                    contactRecord.setValue({ fieldId: 'firstname', value: first_name_val });
                    contactRecord.setValue({ fieldId: 'lastname', value: last_name_val });
                    contactRecord.setValue({ fieldId: 'email', value: email_val });
                    contactRecord.setValue({ fieldId: 'phone', value: phone_val });
                    contactRecord.setValue({ fieldId: 'company', value: customer_id });
                    contactRecord.setValue({ fieldId: 'entityid', value: first_name_val + ' ' + last_name_val });
                    contactRecord.setValue({ fieldId: 'contactrole', value: role_value });
                    contactRecord.setValue({ fieldId: 'custentity_mpex_contact', value: is_mpex_contact });
        ...
        */
        function clearNewContactFields() {
            ...
            $('#role_checkbox').prop('checked', false);
            currRec.setValue({ fieldId: 'custpage_contact_id', value: '' });
            currRec.setValue({ fieldId: 'custpage_row_id', value: '' });
            $('#alert').parent().hide();
        }
        ...
        function createContactsRows() {
            ...
            contactsResultSet.each(function (contactResult) {
                var contact_id = contactResult.searchId;
        ...
        function loadContactsList() {
            ...
            contactsSearch.filetExpression = contactsFilterExpression;
            var contactsResultSet = contactsSearch.run();
