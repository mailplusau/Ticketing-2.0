  ...
  function(error, runtime, search, url, record, format, email, currentRecord) {
      ...
      */
          ...
          $('#submit').click(function() {
              ...
              if (!isNullorEmpty(date_from) && !isNullorEmpty(date_to)) {
                  ...
                  var output = url.resolveScript({
                      deploymentId: 'customdeploy_sl_ticketing_report_month',
                      scriptId: 'customscript_sl_ticketing_report_month',
                  });
      ...
      function overviewChart(date_from, date_to) {
          ...
          var ticketCreatedRes = search.load({
              ...
              id: 'customsearch_ticket_created_report_month'
          });          
          ...
          var ticketClosedRes = search.load({
              type: 'customrecord_mp_ticket',
              id: 'customsearch_ticket_closed_report_month'
          });
          ...
          var ticketProgressRes = search.load({
              type: 'customrecord_mp_ticket',
              id: 'customsearch_ticket_prog_report_month'
          });
          ...
          var ticketOpenRes = search.load({
              type: 'customrecord_mp_ticket',
              id: 'customsearch_ticket_open_report_month'
          });
          ...
          date_set_created.forEach(function(date) {
              ...
              var link1 = '<a href=\'https://1048144.app.netsuite.com/app/site/hosting/scriptlet.nl?script=1306&deploy=1&compid=1048144&custparam_params={"date_from":"' + getMonthStart(date) + '","date_to":"' + getMonthEnd(date) + '"}\' target=_blank>VIEW (per day)</a> ';
              var link2 = '<a href=\'https://1048144.app.netsuite.com/app/site/hosting/scriptlet.nl?script=1289&deploy=1&compid=1048144&custparam_params={"date_from":"' + getMonthStart(date) + '","date_to":"' + getMonthEnd(date) + '"}\' target=_blank>VIEW (per week)</a> ';
      ...
      function staffChart(date_from, date_to) {
          ...
          var staffSearch = search.load({
              type: 'customrecord_mp_ticket',
              id: 'customsearch_ticket_source3_report_month'
          });  
      ...
      function sourceChart(date_from, date_to) {
          ...
          var ticketSourceRes = search.load({
              type: 'customrecord_mp_ticket',
              id: 'customsearch_ticket_source_report_month'
          });
    ...
    function getYearEnd(date) {
      ...
      function firstCompare(search_date, first) {
          ...
          var firstDate = new Date(dateSplit[0], dateSplit[1], 1);
