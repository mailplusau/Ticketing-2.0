 ...
 function(ui, email, runtime, search, record, http, log, redirect, format) {
     ...
     function onRequest(context) {  
         ...
         if (context.request.method === 'GET') {
            ...
            inlineHtml += '<button style="margin-left: 5px; margin-right: 5px; background-color: #FBEA51; color: #379E8F; font-weight: 700; border-color: #379E8F; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="viewclosedtickets" onclick="">View Open MP Tickets</button>';
            inlineHtml += '<button style="margin-left: 5px; margin-right: 5px; background-color: #FBEA51; color: #379E8F; font-weight: 700; border-color: #379E8F; border-width: 2px; border-radius: 15px; height: 30px" type="button" id="viewlosttickets" onclick="">View Closed Tickets</button>';
            ...
            inlineHtml += '<h1 style="font-size: 25px; font-weight: 700; color: #103D39; text-align: center">View Closed-Lost MP Tickets</h1>'
            ...
            form.clientScriptFileId = 4813455;//SB=4796344 PROD = 4813455
